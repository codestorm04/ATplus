class QuestionsController < ApplicationController
  ...
  def addquestion
    ...
    #  redirect_to :action =>"index"
     ...
     File.open(Rails.public_path+"public/articles/"+@filename+"","wb") do |f|
     f.write(@file['filedata'].read)
     @new_article =Article.create(:title => @filename,:field =>@field,:path =>Rails.public_path+"public/articles/"+@filename+"",:author =>@author)
