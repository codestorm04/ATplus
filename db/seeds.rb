...
questions = [{:title => 'When will I finish my project?', :content => 'asdfljaskdlfjklasjfjaslfdl', :questionuser =>'yuan',:article_id => '1',:field => 'software',:filepath=>'www.baidu.com',:liker =>'liu'},
  	         {:title => 'When will I finish my final?', :content => 'asdfljaasjfjaslfdl123133', :questionuser =>'gap',:article_id => '1',:field => 'hardware',:filepath=>'www.google.com',:liker =>'zhang'}   
  	 ]
